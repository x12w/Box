...
namespace BOX {
    ...
    class Struct {
        ...
        Struct *get_Immediately_adjacent_structure(direction dir)const;//get the structs next to this struct in one direction
        Struct *get_moved_structure(direction dir)const;//get the structs need to move when this struct need to move in one direction
